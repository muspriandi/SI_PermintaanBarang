...
import Controller.Controller_LapPesan;
 ...
 * @author User
 */
public class LapPesan extends javax.swing.JFrame {    

    /**
     * Creates new form LapPesan
     */
    
    Controller_LapPesan controller;
    //KONSTRUKTOR
    public LapPesan() {
       initComponents();
        setLocationRelativeTo(this);
       controller = new Controller_LapPesan(this);
       controller.awal();
   }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN PEMESANAN BARANG");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LapPesan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
